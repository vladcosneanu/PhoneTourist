...
public class MainActivity extends FragmentActivity implements SensorEventListener {
     ...
     * values. (slows change)
     */
//    private static final float accelFilteringFactor = 0.00001f;
    private static final float accelFilteringFactor = 0.2f;
    private static final float magFilteringFactor = 0.2f;
